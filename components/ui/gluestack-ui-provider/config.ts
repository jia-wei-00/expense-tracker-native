...
export const config = {
  light: vars({
    ...
    "--color-background-200": "#F2F1F1",
    "--color-background-300": "#DCDBDB",
    "--color-background-400": "#D5D4D4",
    "--color-background-500": "#A2A3A3",
    "--color-background-600": "#8E8E8E",
    "--color-background-700": "#747474",
    "--color-background-800": "#535252",
    "--color-background-900": "#414040",
    "--color-background-950": "#272625",
    "--color-background-1000": "#181718",
  ...
  dark: vars({
    ...
    "--color-background-100": "#272625",
    "--color-background-200": "#414040",
    "--color-background-300": "#535252",
    "--color-background-400": "#747474",
    "--color-background-500": "#8E8E8E",
    "--color-background-600": "#A2A3A3",
    "--color-background-700": "#D5D4D4",
    "--color-background-800": "#DCDBDB",
    "--color-background-900": "#F2F1F1",
    "--color-background-950": "#F6F6F6",
    "--color-background-1000": "#FEFEFE",
